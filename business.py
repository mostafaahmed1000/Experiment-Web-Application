...
class GraphBuilder:
    ...
    def build_nat_choropleth(self):
        ...
        fig = px.choropleth(
            ...
            title="DS Applocants: Nationality"
        )
    ...
    def build_age_hist(self):
        ...
        fig = px.histogram(x=ages, nbins=20, title="DS Apllicant: Distribution")
    ...
    def build_ed_bar(self):
        ...
        # Add axis labels
        fig.update_layout(xaxis_title="Frequancy [count]", yaxis_title="Degree")
